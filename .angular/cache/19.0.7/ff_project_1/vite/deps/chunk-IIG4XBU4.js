...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
   ...
   */
  Si(e) {
    return this.Ri = (t) => __async(this, null, function* () {
  ...
  setDatabaseDeletedListener(e) {
    this.mi.L((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.li.enqueueAndForget(() => __async(this, null, function* () {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.mi.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  start() {
    return __async(this, null, function* () {
      const e = yield this.syncEngine.$i();
      for (const t2 of e) {
  ...
  bs(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.li.enqueueRetryable(() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.Ms.test(t.key)) {
              ...
              yield Promise.all(e2.map((e3) => this.syncEngine.ro(e3)));
            }
          }
        } else this.vs.push(t);
      }));
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.L_.shift();
          __PRIVATE_ensureWriteStream(e2).__(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.G_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.G_.stop(), e.L_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.L_.length} pending writes`), e.L_ = []));
  }))), e.G_;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ha.id), t = this.Ta(this.documents);
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.$a) {
      ...
      n.$a = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      }(n), n.$a = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.xa.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
  ...
  (function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        ...
        let s = yield t2.Ga();
        for (; s; ) {
          const e3 = yield i.Pa(s);
          e3 && n2._updateProgress(e3), s = yield t2.Ga();
        }
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Za.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Za.syncEngine), yield __PRIVATE_fillWritePipeline(this.Za.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield this.persistence.Si(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
    });
  }
  Ha(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      // set it after localStore / remoteStore are started.
      yield this.persistence.Si((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Za.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  za(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  Ga() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.ru();
    });
  }
  /**
  ...
  ou(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.au()) && this.su("Reached the end of bundle when more is expected.");
      }
    ...
    return __async(this, null, function* () {
      ...
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.ko("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.Oo("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
var __PRIVATE_TransactionRunner = class {
  ...
  lu() {
    this.r_.jo(() => __async(this, null, function* () {
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
    ...
    n.eu(), e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=chunk-IIG4XBU4.js.map
